...
it copies these changes to other nodes that it is connected to.
...
of settings like which files should be replicated and how
...
operates autonomously as intended. My program works
as intended as a file synchronisation tool and addresses
