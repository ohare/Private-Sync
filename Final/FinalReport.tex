...
\begin{itemize}
    ...
    \item FSEvents
        ...
        %\footnote{https://developer.apple.com/library/mac/#documentation/Darwin/Conceptual/FSEvents_ProgGuide/Introduction/Introduction.html}
        \cite{fsevents-intro}.
        It is similar
...
\section{Dealing with Sub-nodes}
