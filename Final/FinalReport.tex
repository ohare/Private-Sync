...
\begin{figure}[htp]
    \begin{subfigure}[b]{0.5\textwidth}
        \centering
        \includegraphics[scale=0.35]{images/line-graph.png}
        \caption{Line - Generated Graph of Topology}
        \label{fig:line_graph}
    \end{subfigure}
    \begin{subfigure}[b]{0.5\textwidth}
        \includegraphics[scale=0.35]{images/line-scp-10-fixes.png}
        \caption{SCP}
        \label{fig:line_scp}
    \end{subfigure}
    ...
    \begin{subfigure}[b]{0.5\textwidth}
        \centering
        \includegraphics[scale=0.35]{images/line-rsync-10-fixes.png}
        \caption{Rsync}
        \label{fig:line_rsync}
    \end{subfigure}
    \begin{subfigure}[b]{0.5\textwidth}
        \includegraphics[scale=0.35]{images/line-uni-10-fixes.png}
        \caption{Unison}
        \label{fig:line_uni}
    \end{subfigure}
