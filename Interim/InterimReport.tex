...
dies.
% illustrate why Dropbox isn't enough.

\begin{figure}[htb]
    \begin{subfigure}[b]{0.5\textwidth}
        \centering
        \includegraphics[scale=0.35]{PersonalGraph.png}
        \caption{Personal Network}
        \label{fig:personal_graph}
    \end{subfigure}
    \begin{subfigure}[b]{0.5\textwidth}
        \includegraphics[scale=0.35]{CorporateGraph.png}
...
% why basic? is this enough? I think you need to provide some sort of justification

-- Insert network graphs --

% I think you might need to give a conceptual roadmap of the subsections below, or they look a bit disconnected.
...
% "algorithms that give as near to optimal as possible" perhaps, rather than the algorithms being near-optimal 
...
% why not collections of directories as opposed to sub-node = directory?
...
% what do you mean by tweak here?
...
% sentence doesn't work starting "Which directories" I suspect
